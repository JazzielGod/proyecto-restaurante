...
const ModalPlatillo = ({ isOpen, onClose }) => {
    ...
    useEffect(() => {
        axios.get(`${url}inventarios`).then((response) => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const response1 = await axios.post(`${url}platillos`, formData);
            ...
            await axios.post(`${url}platillosInventarios/${idPlatillo}`, formData2);
